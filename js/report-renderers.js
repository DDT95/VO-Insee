(function () {
  ...
  function renderLogement(t, territoryWord, profile) {
    ...
    const partialNote = profile && profile.kind === "epci" && l.perimetre_partiel
    ...
    return `
      ${partialNote}
      ${section("01 · REPÈRES", `${territoryWord || "ce territoire"} en six chiffres`, `<div class="kpi-grid kpi-grid-six">
  ...
  window.VOInsee.reportRenderers = {
    habitants: renderHabitants,
    emploi_mobilites: renderEmploi,
    logement: renderLogement,
    economie_equipements: renderEconomie,
  };
  window.VOInsee.reportHelpers = { section, kpi, donut, bars, barsValue, comingSoon, asDonut, fmt, pctFmt };
})();
